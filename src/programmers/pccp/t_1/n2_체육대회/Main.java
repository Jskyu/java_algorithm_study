...
/** <a href="https://school.programmers.co.kr/learn/courses/15008/lessons/121684">체육대회</a>
 * 문제 설명
 * 당신이 다니는 학교는 매년 체육대회를 합니다. 체육대회는 여러 종목에 대해 각 반의 해당 종목 대표가 1명씩 나와 대결을 하며, 한 학생은 최대 한개의 종목 대표만 할 수 있습니다. 
 * 당신의 반에서도 한 종목당 1명의 대표를 뽑으려고 합니다. 학생들마다 각 종목에 대한 능력이 다르지만 이 능력은 수치화되어 있어 미리 알 수 있습니다. 
...
public class Main {
    ...
    public static void main(String[] args) {
        int[][][] ability = {
                {{70, 0, 70}, {100, 100, 100}, {30, 30, 30}, {40, 10, 10}, {20, 5, 0}},
                {{20, 30}, {30, 20}, {20, 30}}
        };
        ...
        for (int i = 0; i < ability.length; i++) {
            int answer = new Solution().solution(ability[i]);
