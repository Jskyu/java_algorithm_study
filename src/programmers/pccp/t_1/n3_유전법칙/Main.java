...
/**<a href="https://school.programmers.co.kr/learn/courses/15008/lessons/121685">유전법칙</a>
 * 문제 설명
 ...
 * <img alt="image1.PNG" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/22c1e8fc-093c-491b-8604-dad8f553b631/image1.PNG">
 *
 ...
 *
 * <img alt="image2.PNG" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/95a0f907-0e3c-4c4e-acfe-bb489685802b/image2.PNG">
 *
 * 진송이는 이러한 완두콩의 자가 수분 실험 결과를 정리하고 싶어합니다. 하지만, 세대를 거듭할수록, 완두콩의 수가 너무 많아져 모든 가계도를 기록하기 어려워졌습니다.
...
public class Main {
    public static void main(String[] args) {
        int[][][] queries = {
                ...
                {{3, 1}, {2, 3}, {3, 9}},
                {{4, 26}, {4, 20}, {4, 45}, {4, 48}},
                {{3, 1}, {3, 5}, {3, 3}, {3, 12}, {3, 13}, {3, 16}},
                {{4, 37}, {4, 38}, {4, 39}, {4, 40}},
                {{5, 149}, {5, 150}, {5, 151}, {5, 152}},
                {{15, 1}, {15, 268435456}, {15, 83886080}},
                {{2, 1}, {2, 2}, {2, 3}, {2, 4}}
        };
        ...
        for (int i = 0; i < queries.length; i++) {
            String[] answer = new Solution().solution(queries[i]);
