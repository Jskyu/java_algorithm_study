...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("case 1\n정답: " + result1 + "\n풀이: " + new Solution().solution(bandage1, health1, attacks1) + "\n");
        System.out.println("case 2\n정답: " + result2 + "\n풀이: " + new Solution().solution(bandage2, health2, attacks2) + "\n");
        System.out.println("case 3\n정답: " + result3 + "\n풀이: " + new Solution().solution(bandage3, health3, attacks3) + "\n");
        System.out.println("case 4\n정답: " + result4 + "\n풀이: " + new Solution().solution(bandage4, health4, attacks4));
    }
}
