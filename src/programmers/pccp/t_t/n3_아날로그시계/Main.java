 ...
 * <img alt="ex1-1.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/fee10e9e-2871-4caf-94e4-b55b2dbcaea9/ex1-1.png">
 *
 * 가장 짧은 바늘이 시침, 중간 길이인 바늘이 분침, 가장 긴 바늘이 초침입니다.
 * 알람이 울리는 횟수를 세기 시작한 시각은 0시 5분 30초입니다.
 * 이후 0시 6분 0초까지 초침과 시침/분침이 겹치는 일은 없습니다.
 * <img alt="ex1-2.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/61dd5cec-944e-4f48-a3ae-95fd498e197e/ex1-2.png">
 *
 * 약 0시 6분 0.501초에 초침과 시침이 겹칩니다. 이때 알람이 한 번 울립니다.
 * 이후 0시 6분 6초까지 초침과 시침/분침이 겹치는 일은 없습니다.
 * <img alt="ex1-3.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/d2274db1-cb08-45d0-a6d4-ac6d76705f67/ex1-3.png">
 *
 ...
 * <img alt="ex2-1.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/3b0781d9-0640-428e-bd9d-4d8c70a3c578/ex2-1.png">
 *
 * 알람이 울리는 횟수를 세기 시작한 시각은 12시 0분 0초입니다.
 * 초침과 시침, 분침이 겹칩니다. 이때 알람이 한 번 울립니다. 이와 같이 0시 정각, 12시 정각에 초침과 시침, 분침이 모두 겹칠 때는 알람이 한 번만 울립니다.
 * <img alt="ex2-2.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/9f178f43-9819-4b7a-8ed1-783cec0febe3/ex2-2.png">
 *
 ...
 *
 * 입출력 예 #4
 * <img alt="ex3-1.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/1b7bbaf3-652a-469a-ab36-3434b77920e3/ex3-1.png">
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < h1.length; i++) {
            int answer = new Solution().solution(h1[i], m1[i], s1[i], h2[i], m2[i], s2[i]);
