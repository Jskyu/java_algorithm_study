 ...
 * <p>
 * 자카드 유사도는 집합 간의 유사도를 검사하는 여러 방법 중의 하나로 알려져 있다. 두 집합 A, B 사이의
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] str1 = {"FRANCE", "handshake", "aa1+aa2", "E=M*C^2", "BAAAA"};
        String[] str2 = {"french", "shake hands", "AAAA12", "e=m*c^2", "AAA"};

        for (int i = 0; i < str1.length; i++) {
            int result = s.solution(str1[i], str2[i]);
            System.out.println("s.solution(" + str1[i] + ", " + str2[i] + "s) = " + result+"\n");
        }
    }
}
