...
public class Main {
    ...
    public static void main(String[] args){
        ...
        System.out.println("answer = " + solution.solution(bridgeLength, weight, truckWeights));
        System.out.println("answer2 = " + solution.solution2(bridgeLength, weight, truckWeights));
    }
}
