 ...
 *
 * 입출력 예 설명
 * <img alt="그림.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/9641b37b-9c9d-4eec-bd92-bec75acf2338/%EA%B7%B8%EB%A6%BC.png">
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < targets.length; i++) {
            int answer = new Solution().solution(targets[i]);
