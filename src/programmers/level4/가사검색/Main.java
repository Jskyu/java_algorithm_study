...
/**<a href="https://programmers.co.kr/learn/courses/30/lessons/60060">가사 검색</a>

 친구들로부터 천재 프로그래머로 불리는 "프로도"는 음악을 하는 친구로부터 자신이 좋아하는 노래 가사에 사용된 단어들 중에
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] queries = {"fro??", "????o", "fr???", "fro???", "pro?", "fr???", "?????", "??????", "?"};
        int[] answers = {3, 2, 4, 1, 0, 4, 5, 1, 0};
