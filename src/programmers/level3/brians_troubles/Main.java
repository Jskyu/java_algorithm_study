...
public class Main {
    public static void main(String[] args) {
        ...
        print(s.solution(""), "");
        print(s.solution("AaaA"), INVALID);
        print(s.solution("A"), "A");
        print(s.solution("a"), INVALID);
        print(s.solution("AA"), "AA");
        print(s.solution("Aa"), INVALID);
        print(s.solution("aA"), INVALID);
        print(s.solution("aa"), INVALID);
        print(s.solution("aAa"), "A");
        print(s.solution("AaA"), "AA");
        print(s.solution("aaA"), INVALID);
        print(s.solution("Aaa"), INVALID);
        print(s.solution("AAa"), INVALID);
        print(s.solution("aaA"), INVALID);
        print(s.solution("Aaa"), INVALID);
        print(s.solution("AAaA"), "A AA");
        print(s.solution("AaAaAbB"), "A A AB");
        print(s.solution("AaAbBBb"), "AA BB");
        print(s.solution("AaABbBbB"), "AA B B B");
        print(s.solution("aAbAbAacAaAc"), INVALID);
        print(s.solution("aAaAa"), INVALID);
        print(s.solution("AAAAxAxAA"), "AAAA A AA");
        print(s.solution("aAbAcAcAcAa"), INVALID);
        print(s.solution("AaAaAbBbBbB"), "A A ABBB");
        print(s.solution("aAAabBcBb"), "AA BB");
        print(s.solution("A A"), INVALID);
        print(s.solution("aAbAa"), "AA");
        print(s.solution("AAAaBaAbBBBBbCcBdBdBdBcCeBfBeGgGGjGjGRvRvRvRvRvR"), "AAA B A BBBB C BBBB C BB GG G G G RRRRRR");
        print(s.solution("AbAaAbAaC"), INVALID); // AbA aAbAa C
        print(s.solution("AbAaAbAaCa"), INVALID);
        print(s.solution("abAba"), INVALID);
        print(s.solution("aCaCa"), INVALID);
        print(s.solution("aGbWbFbDakGnWnLk"), "GWFD GWL");
        print(s.solution("aHbEbLbLbacWdOdRdLdDc"), INVALID);
        print(s.solution("aHbEbLbLbOacWdOdRdLdDc"), "HELLO WORLD");
        print(s.solution("aHELLOWORLDa"), "HELLOWORLD");
        print(s.solution("aIaAM"), "I AM");
        print(s.solution("AsAzAsA"), "A AA A");
        print(s.solution("AxAxAxAoBoBoB"), INVALID);
        print(s.solution("bAaOb"), "AO");
        print(s.solution("baHELLOabWORLD"), INVALID);
        print(s.solution("bTxTxTaTxTbkABaCDk"), INVALID);
        print(s.solution("GgGGjGjGRvRvRvRvRvR"), "GG G G G RRRRRR");
        print(s.solution("GjGjGRvRvRvRvRvR"), "G G G RRRRRR");
        print(s.solution("HaEaLaLaObWORLDb"), "HELLO WORLD");
        print(s.solution("HaEaLaLaOWaOaRaLaD"), INVALID);
        print(s.solution("HaEaLaLObWORLDb"), "HELL O WORLD");
        print(s.solution("HELLO WORLD"), INVALID);
        print(s.solution("HELLOWbObRbLb"), INVALID);
        print(s.solution("SpIpGpOpNpGJJqOqA"), "SIGONG JJ O A");
        print(s.solution("SpIpGpOpNpGJqOqA"), "SIGONG J O A");
        print(s.solution("TxTxTxbAb"), INVALID);
        print(s.solution("xAaAbAaAx"), INVALID);
        print(s.solution("XcXbXcX"), "X XX X");
        print(s.solution("aAaAaAa"), INVALID);
        print(s.solution("AaAaAbDDbzWaWaWz"), INVALID);
    }

    static void print(String answer, String result) {
        System.out.println("결과: " + answer.equals(result) + " 제출: " + answer + ", 답: " + result);
    }
}
