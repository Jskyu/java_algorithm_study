 ...
 *
 * <img alt="2021_kakao_taxi_01.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/715ff493-d1a0-44d8-9273-a785280b3f1e/2021_kakao_taxi_01.png">
 ...
 *
 * 입출력 예 #2
 * <img alt="2021_kakao_taxi_02.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/934fcb5a-f844-4b02-b7fa-46198123be05/2021_kakao_taxi_02.png">
 * 합승을 하지 않고, B는 3→2→1, A는 3→6→4 경로로 각자 택시를 타고 가는 것이 최저 예상 택시요금입니다.
 * 따라서 최저 예상 택시요금은 (3 + 6) + (1 + 4) = 14원 입니다.
 *
 * 입출력 예 #3
 * <img alt="2021_kakao_taxi_03.png" src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/179cc8ad-73d2-46c9-95e9-2363f3cb345d/2021_kakao_taxi_03.png">
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < result.length; i++) {
            int answer = new Solution().solution(n[i], s[i], a[i], b[i], fares[i]);
